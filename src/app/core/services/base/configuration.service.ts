...
import { AppTranslationService } from './apptranslation.service';
...
import { UserConfiguration } from '@core/models/base/user-configuration.model';
...
export class ConfigurationService {
  ...
  private loadLocalChanges() {
    ...
    if (this.localStorage.exists(DBkeys.SHOW_DASHBOARD_NOTIFICATIONS)) {
      this._showDashboardNotifications = this.localStorage.getDataObject<boolean>(
