...
export class LocalStoreManagerService {
  ...
  public saveSessionData(data: unknown, key = LocalStoreManagerService.DBKEY_USER_DATA) {
  ...
  public saveSyncedSessionData(data: unknown, key = LocalStoreManagerService.DBKEY_USER_DATA) {
    this.testForInvalidKeys(key);
  ...
  public savePermanentData(data: unknown, key = LocalStoreManagerService.DBKEY_USER_DATA) {
    this.testForInvalidKeys(key);
  ...
  public getDataObject<T>(
    key = LocalStoreManagerService.DBKEY_USER_DATA,
    isDateType = false
  ): T | null {
